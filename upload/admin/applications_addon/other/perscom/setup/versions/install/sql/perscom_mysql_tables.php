...
$TABLE[] = "CREATE TABLE IF NOT EXISTS perscom_admin_units (
...
$TABLE[] = "CREATE TABLE IF NOT EXISTS perscom_awards (
  primary_id_field int(11) NOT NULL auto_increment,
  title text,
  award_image text,
  history mediumtext,
...
$TABLE[] = "CREATE TABLE IF NOT EXISTS perscom_combat_units (
  primary_id_field int(11) NOT NULL auto_increment,
  name text,
  unit_position text,
  nickname text,
...
$TABLE[] = "CREATE TABLE IF NOT EXISTS perscom_leave_of_absences (
  primary_id_field int(11) NOT NULL auto_increment,
...
$TABLE[] = "CREATE TABLE IF NOT EXISTS perscom_muster_logs (
  primary_id_field int(11) NOT NULL auto_increment,
  member_id int(11) NOT NULL DEFAULT '0',
  display_name text,
  date text,
...
$TABLE[] = "CREATE TABLE IF NOT EXISTS perscom_personnel (
  primary_id_field int(11) NOT NULL auto_increment,
...
$TABLE[] = "CREATE TABLE IF NOT EXISTS perscom_requests (
  primary_id_field int(11) NOT NULL auto_increment,
  member_id int(11) NOT NULL DEFAULT '0',
...
$TABLE[] = "CREATE TABLE IF NOT EXISTS perscom_service_records (
  primary_id_field int(11) NOT NULL auto_increment,
  member_id int(11) NOT NULL DEFAULT '0',
  members_display_name text,
  date text,
...
$TABLE[] = "CREATE TABLE IF NOT EXISTS perscom_temporary_pass_requests (
  primary_id_field int(11) NOT NULL auto_increment,
  member_id int(11) NOT NULL DEFAULT '0',
  display_name text,
  explanation text,
...
$TABLE[] = "CREATE TABLE IF NOT EXISTS perscom_weapons (
  primary_id_field int(11) NOT NULL auto_increment,
  make_and_model text,
  caliber text,
  weight text,
