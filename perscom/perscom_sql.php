<?php exit;?>
CREATE TABLE IF NOT EXISTS perscom_admin_units (
...
CREATE TABLE IF NOT EXISTS perscom_awards (
  primary_id_field int(11) NOT NULL auto_increment,
  title text,
  award_image text,
  history mediumtext,
...
CREATE TABLE IF NOT EXISTS perscom_combat_units (
  primary_id_field int(11) NOT NULL auto_increment,
  name text,
  unit_position text,
  nickname text,
...
CREATE TABLE IF NOT EXISTS perscom_leave_of_absences (
  primary_id_field int(11) NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS perscom_muster_logs (
  primary_id_field int(11) NOT NULL auto_increment,
  member_id int(11) NOT NULL DEFAULT '0',
  display_name text,
  date text,
...
CREATE TABLE IF NOT EXISTS perscom_personnel (
  primary_id_field int(11) NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS perscom_ranks (
  primary_id_field int(11) NOT NULL auto_increment,
  `order` int(11) NOT NULL DEFAULT '0',
  title text,
  abbreviation text,
...
CREATE TABLE IF NOT EXISTS perscom_requests (
  primary_id_field int(11) NOT NULL auto_increment,
  member_id int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS perscom_service_records (
  primary_id_field int(11) NOT NULL auto_increment,
  member_id int(11) NOT NULL DEFAULT '0',
  members_display_name text,
  date text,
...
CREATE TABLE IF NOT EXISTS perscom_settings (
  primary_id_field int(11) NOT NULL auto_increment,
  title text,
  `key` text,
...
CREATE TABLE IF NOT EXISTS perscom_temporary_pass_requests (
  primary_id_field int(11) NOT NULL auto_increment,
  member_id int(11) NOT NULL DEFAULT '0',
  display_name text,
  explanation text,
...
CREATE TABLE IF NOT EXISTS perscom_weapons (
  primary_id_field int(11) NOT NULL auto_increment,
  make_and_model text,
  caliber text,
  weight text,
